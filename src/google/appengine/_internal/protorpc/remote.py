...
class _ServiceClass(type):
  ...
  def __new_sync_method(cls, async_method):
    ...
    def sync_method(self, *args, **kwargs):
      ...
      """
      return async_method(self.async_stub, *args, **kwargs).response
  ...
  def __create_async_methods(cls, remote_methods):
    ...
    """
    async_methods = {}
    for method_name, method in six.iteritems(remote_methods):
  ...
  def __create_sync_methods(cls, async_methods):
    ...
    """
    sync_methods = {}
    for method_name, async_method in six.iteritems(async_methods):
  ...
  def __init__(cls, name, bases, dct):
    ...
    if StubBase not in bases:
      ...
      def __init__(self, transport):
        ...
        self.async_stub = cls.AsyncStub(transport)
...
class Service(six.with_metaclass(_ServiceClass, object)):
  ...
  def new_factory(cls, *args, **kwargs):
    ...
    service_factory.__doc__ = ('Creates new instances of service %s.\n\n'
                               'Returns:\n'
                               '  New instance of %s.' %
