...
class _EnumClass(_DefinitionClass):
  ...
  def __init__(cls, name, bases, dct):
    ...
    if bases != (object,):
      ...
      for attribute, value in six.iteritems(dct):
  ...
  def __iter__(cls):
    ...
    """
    return six.itervalues(cls.__by_number)
  ...
  def names(cls):
    ...
    """
    return six.iterkeys(cls.__by_name)
  ...
  def numbers(cls):
    ...
    """
    return six.iterkeys(cls.__by_number)
...
class Enum(six.with_metaclass(_EnumClass, object)):
  ...
  def __eq__(self, other):
    """Equality operator based on number."""
    if not isinstance(other, type(self)):
      return NotImplemented
    return self.number == other.number

  def __ne__(self, other):
    """Non-equality operator based on number."""
    if not isinstance(other, type(self)):
      return NotImplemented
    return self.number != other.number

  def __lt__(self, other):
    """Less than operator based on number."""
    if not isinstance(other, type(self)):
      return NotImplemented
    return self.number < other.number

  def __le__(self, other):
    """Less than or equal operator based on number."""
    if not isinstance(other, type(self)):
      return NotImplemented
    return self.number <= other.number

  def __gt__(self, other):
    """Greater than operator based on number."""
    if not isinstance(other, type(self)):
      return NotImplemented
    return self.number > other.number

  def __ge__(self, other):
    """Greater than or equal operator based on number."""
    if not isinstance(other, type(self)):
      return NotImplemented
    return self.number >= other.number
...
class Message(six.with_metaclass(_MessageClass, object)):
  ...
  def check_initialized(self):
    ...
    """
    for name, field in six.iteritems(self.__by_name):
  ...
  def all_fields(cls):
    ...
    """
    return six.itervalues(cls.__by_name)
  ...
  def __setattr__(self, name, value):
    ...
    """
    if name in self.__by_name or six.ensure_str(name).startswith('_Message__'):
...
class FieldList(list):
  ...
  def __new__(cls, *args, **kwargs):
    """Custom __new__ to enable unpickling.

    Args:
      *args: args to pass to the __init__ ctor.
      **kwargs: kwargs to pass to the __init__ ctor. The `_being_unpickled`
        keyword is special: it is only passed during unpickling.
    """
    being_unpickled = kwargs.pop('_being_unpickled', None)
    obj = super(FieldList, cls).__new__(cls, *args, **kwargs)
    if being_unpickled:
      ...
      obj.extend = lambda values: list.extend(obj, values)
    return obj
  ...
  def __getnewargs_ex__(self):
    """Returns pickle-specific args for `__new__`."""
    return (), {'_being_unpickled': True}
  ...
  def __setstate__(self, state):
    """Set state after unpickling (but after values appended).
...
@six.add_metaclass(_FieldMetaclass)
class Field(object):
...
class MessageField(Field):
  ...
  def __init__(self,
    ...
    """
    valid_type = (
        isinstance(message_type, six.string_types) or
        (message_type is not Message and isinstance(message_type, type) and
...
class EnumField(Field):
  ...
  def __init__(self, enum_type, number, **kwargs):
    ...
    """
    valid_type = (
        isinstance(enum_type, six.string_types) or
        (enum_type is not Enum and isinstance(enum_type, type) and
...
def find_definition(name, relative_to=None, importer=__import__):
  ...
  name_path = six.ensure_str(name).split('.')
    ...
    for node in name_path:
      ...
      if attribute is not None:
        ...
        if next is None or isinstance(next, types.ModuleType):
          ...
          try:
            fromitem = six.ensure_str(module_name).split('.')[-1]
    ...
    if isinstance(found, type) and issubclass(found, (Enum, Message)):
      ...
      if relative_to is None:
        ...
        if isinstance(relative_to, types.ModuleType):
          ...
          module_path = six.ensure_str(relative_to.__name__).split('.')[:-1]
          if not module_path:
            relative_to = None
          else:
          ...
          if parent is None:
            last_module_name = six.ensure_str(
                relative_to.__module__).split('.')[-1]
            relative_to = importer(
